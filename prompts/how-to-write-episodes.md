...
* [EPISODE]
A clear statement of the single goal.
* [ACCEPTANCE]
Checkable criteria phrased as questions.
* (Optional) [RISK]
Risky assumptions phrased as questions, in order of risk.
* (Optional) [SUB-TASKS]
The execution plan, one bounded step per bullet.
* (Optional) [OUTPUT FORMAT]
The response representation.
* (Optional) [FILES]
The files involved in the episode.
* (Optional) [BRANCH]
The git branch name for the episode.
